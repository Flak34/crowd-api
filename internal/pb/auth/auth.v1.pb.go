...
func (x *LoginResponse) Reset() {
	*x = LoginResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_auth_auth_v1_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LoginResponse) Descriptor() ([]byte, []int) {
	return file_auth_auth_v1_proto_rawDescGZIP(), []int{3}
}
...
var file_auth_auth_v1_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x43, 0x0a, 0x0f, 0x52,
	...
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xb4, 0x01, 0x0a, 0x06, 0x41, 0x75, 0x74, 0x68, 0x56,
	0x31, 0x12, 0x5a, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x18, 0x2e,
	...
	0x73, 0x65, 0x22, 0x19, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x13, 0x22, 0x11, 0x2f, 0x61, 0x75, 0x74,
	0x68, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x4e, 0x0a,
	...
	0x61, 0x75, 0x74, 0x68, 0x2f, 0x76, 0x31, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x42, 0x20, 0x5a,
	0x1e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x46, 0x6c, 0x61, 0x6b,
	0x33, 0x34, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x3b, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x76, 0x31, 0x62,
...
var file_auth_auth_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_auth_auth_v1_proto_depIdxs = []int32{
	0, // 0: auth.v1.AuthV1.Register:input_type -> auth.v1.RegisterRequest
	2, // 1: auth.v1.AuthV1.Login:input_type -> auth.v1.LoginRequest
	1, // 2: auth.v1.AuthV1.Register:output_type -> auth.v1.RegisterResponse
	3, // 3: auth.v1.AuthV1.Login:output_type -> auth.v1.LoginResponse
...
func file_auth_auth_v1_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_auth_auth_v1_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
